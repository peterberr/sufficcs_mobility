...
def subcenters(city):
    ...
    # else:
    fp = '../outputs/density_geounits/'+city+'_pop_density_lowres.csv' # here is what we change in the LOW version
    city_poly=import_csv_w_wkt_to_gdf(fp,crs0,gc='geo_unit')
    city_poly.rename(columns={'geo_unit':'geocode'},inplace=True)
    ...
    # calculate distance to the main city center, identified by the cp.indexto_csvs
    ...
    fp = '../outputs/CenterSubcenter/'+city+'_dist_lowres.csv'
    ...
    # fp = '../outputs/CenterSubcenter/'+city+'_coords_lowres.csv'
